...
```
Install with bunx skills add <owner/repo@skill>
...
To install it:
bunx skills add vercel-labs/agent-skills@vercel-react-best-practices
...
- Suggest the user could create their own skill with `bunx skills init`
